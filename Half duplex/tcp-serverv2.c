...
while(1)
{
	...
	printf("The msg rececived from client: %s\n ", buffer);

	/* Write some message to the client as a notification/Acknowledgement  */
	
	char successmsg[1024] = "Cheers!!, Received the message from the client";
